...
沒訊號可看,任一邊有量還是留著讓使用者自己判斷。任一欄位是 `null`(資料
缺漏)一律不濾,避免把「抓不到資料」誤判成「沒活動」。
...
活躍度濾掉 N 檔」。實測(2026-09-09):FOMO個股查詢濾掉 2702/9902、
爆量個股查詢濾掉 1220/1456/3168、暴跌FOMO個股查詢濾掉 3150/5546。
